...
- (void) presentNotification:(JCNotificationBanner*)notification
  ...
  // Center the banner horizontally.
    CGFloat x = [[UIApplication sharedApplication]isStatusBarHidden] ? [[UIScreen mainScreen]bounds].size.width/2 - bannerSize.width/2 : (MAX(statusBarSize.width, statusBarSize.height) / 2) - (bannerSize.width / 2);  // Position the banner offscreen vertically.
